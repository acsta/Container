...
namespace TaoTie
{
    ...
    { 
        ...
        public static readonly float DesignScreenWidth =
                SystemInfoHelper.screenWidth > SystemInfoHelper.screenHeight ? Mathf.Max(dWidth, dHeight) : Mathf.Min(dWidth, dHeight);
        public static readonly float DesignScreenHeight =
                SystemInfoHelper.screenWidth > SystemInfoHelper.screenHeight ? Mathf.Min(dWidth, dHeight) : Mathf.Max(dWidth, dHeight);
        ...
        public static readonly int AllLayer = LayerMask.GetMask("UI", "Default", "Entity", "Water", "HitBox", "HitScene",
