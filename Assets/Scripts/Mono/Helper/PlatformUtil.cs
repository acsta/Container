...
namespace TaoTie
{
    public class PlatformUtil
    {
        ...
        {
#if UNITY_WEBGL && !UNITY_EDITOR
#if UNITY_WEBGL_TT || UNITY_WEBGL_KS || UNITY_WEBGL_WeChat || UNITY_WEBGL_TAPTAP || UNITY_WEBGL_QG || UNITY_EDITOR || UNITY_WEBGL_MINIHOST || UNITY_WEBGL_BILIGAME || UNITY_WEBGL_4399 || UNITY_WEBGL_FACEBOOK
            return true;
#endif
